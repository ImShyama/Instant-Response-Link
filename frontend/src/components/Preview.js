...
const Preview = (props) => {
    ...
    const { viewlinks, viewsetting } = props
    ...
    return (
        <div className='' style={backgroundStyle} >
            ...
            <div style={styleSearch.search(isRowBased)}>
                {viewsetting?.search && <input type="text" onChange={(e) => setSearch(e.target.value)} style={customStyles.search(isRowBased)} id="gsearch" name="gsearch" placeholder='Search' />}
            </div>
            <div>
            ...
            <div className='d-flex justify-content-evenly my-3' >
                ...
                {viewsetting?.footer && <div className='d-flex justify-content-evenly'>
                ...
                {viewsetting?.footer && viewsetting?.rightFooter[0].rightFooterName !== "" ?
                    <div><a type="button" class="btn btn-primary" href={viewsetting.leftFooter[0].leftFooterURL} >{viewsetting.rightFooter[0].rightFooterName}</a></div>
