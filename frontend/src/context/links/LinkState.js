...
const LinkState = (props) => {
  ...
  const updateHeaderSetting = async (
    ...
    const response = await fetch(`${host}/api/settings/updateheaderStyle`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
  ...
  const updateDescriptionSetting = async (
    ...
    const response = await fetch(
      `${host}/api/settings/updatedescriptionStyle`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const updatedleftfooterStyle = async (
    ...
    const response = await fetch(
      `${host}/api/settings/updatedleftfooterStyle`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const updatedrightfooterStyle = async (
    ...
    const response = await fetch(
      `${host}/api/settings/updatedrightfooterStyle`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const updatedpaginationStyle = async (
    ...
    const response = await fetch(
      `${host}/api/settings/updatedpaginationStyle`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const updatedLinksStyle = async (
    ...
    const response = await fetch(`${host}/api/settings/updatedLinksStyles`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
